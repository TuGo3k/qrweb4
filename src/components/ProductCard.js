...
const ProductCard = () => {
  const foods = [
    { image: "/product1.jpg", price: 15.0, title: "Tuna Chops" },
    { image: "/product2.jpg", price: 15.0, title: "Deep Prawn Fry" },
    { image: "/product3.jpg", price: 15.0, title: "Sliced Sea Fish" },
    { image: "/product4.jpg", price: 15.0, title: "Tuna Chops" },
  ];
  return (
    <Swiper
      ...
      {foods.map((el, index) => (
        <SwiperSlide key={index}>
          <div className="overflow-hidden flex items-center justify-center bg-[#f9f7ed]">
            <div className="block relative border-4 border-[#c2b59d] w-[166px] bg-white  shadow-md overflow-hidden ">
              {/* Badge */}
