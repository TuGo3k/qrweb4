...
const ThemeCard = () => {
  return (
    <div className="bg-cream rounded-lg text-start   w-[200px] mx-auto py-[80px]">
      {/* Icon Section */}
      ...
      {/* Title Section */}
      <h3 className="text-brown text-xl font-bold mb-2">
        Bella Model{" "}
        <span className="text-gray-700 font-normal">- A Restaurant Theme</span>
      </h3>
